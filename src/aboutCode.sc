...
(instance aboutCode of Code
	...
	(method (doit &tmp [temp0 300] [temp300 300])
		...
		(Load rsVIEW 993 989)
		(if
		(not (Print font: gFont addText: 1 0 0 1 0 0 13 init:))
			(self dispose:)
			(return)
		)
		(if
		(not (Print font: gFont addText: 1 0 0 2 0 0 13 init:))
			(self dispose:)
			(return)
		)
		(Message msgGET 13 1 0 0 3 @temp0)
		(Format @temp300 @temp0 global27)
