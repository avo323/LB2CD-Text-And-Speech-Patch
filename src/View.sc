...
(class Actor of Prop
	...
	(method (setDirection newDirection &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9)
		(= temp0
		...
		(if (and (= temp7 (global2 obstacles?)) global67)
			...
			(= temp8 (proc999_6 temp6 2))
			(= temp9 (proc999_6 temp6 3))
			(= temp2 (- temp8 x))
			(= temp3 (- temp9 y))
			...
			(if gNewList
				...
				(if
					(or
						(!= (proc999_6 temp6 2) (+ x temp2))
						(!= (proc999_6 temp6 3) (+ y temp3))
					)
