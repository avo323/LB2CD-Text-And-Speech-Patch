...
(procedure (localproc_013c)
	(= local1
		(Print
			font: 69
			addText: 5 0 0 1 (proc0_11 0 0 42 0 0) 0
...
(procedure (localproc_0221)
	(= local2
		(Print
			addText: 5 0 0 2 (proc0_11 0 0 67 0 0) 0
			addButton: 1 6 0 0 1 0 17
			addButton: 2 6 0 0 2 (proc0_11 128 80 128 80 96) 17
			addButton: 3 6 0 0 3 0 34
			addButton: 4 6 0 0 4 (proc0_11 80 80 128 80 80) 34
			addButton: 5 6 0 0 5 0 51
			addButton: 6 6 0 0 6 (proc0_11 80 80 128 80 80) 51
			addButton: 7 6 0 0 7 0 68
			addButton: 8 6 0 0 8 0 85
			addButton: 9 6 0 0 9 0 102
			addButton: 10 6 0 0 10 (proc0_11 0 0 8 0 0) 119
			addButton: 11 6 0 0 11 0 136
			addButton: 12 6 0 0 12 0 153
			addButton: 13 6 0 0 13 (proc0_11 48 48 64 48 80) 153
			init:
		)
	)
)
			...
			(2
				...
				(switch local0
					...
					(12
						(if (!= local1 11)
							(= local0 15)
							(gLb2Messager say: 8 0 6 0 self)
						else
							(++ local0)
							(gLb2Messager say: 8 0 5 0 self)
						)
					)
					(13
						(if (!= local1 6)
					...
					(15
						(if (!= local1 8)
							(gLb2Messager say: 9 0 0 0 self)
						else
							(gLb2Messager say: 9 0 7 0 self)
						)
						(++ local0)
					)
					(16
						(if (!= local1 5)
							(gLb2Messager say: 10 0 0 0 self)
						else
							(gLb2Messager say: 10 0 8 0 self)
						)
						(++ local0)
					)
				)
...
(instance sAfterQuestions of Script
	...
	(method (changeState newState &tmp [temp0 100])
		(switch (= state newState)
			...
			(2
				(gLb2Messager say: 7 0 9 0 self)
			)
			(3
				(gLb2Messager say: 3 0 local3 0 self)
			)
			(4
				(cond 
					((== global126 1)
			...
			(8
				...
				(headline
					init:
					loop: (if (proc999_5 global126 2 4) 2 else global126)
					hide:
				)
				(global2 drawPic: 780)
			...
			(9
				(gWrapSound number: 760 flags: 1 loop: 1 play:)
				(paper show:)
