		...
		(switch (= state newState)
			(0
				...
				(creditProp
					...
					cel: 0
					ignoreActors:
					setCycle: (if (proc999_5 local0 14 15 16) Fwd else 0)
				)
				(if (proc999_5 local0 14 15 16)
			...
			(1
				(if (proc999_5 local0 5 6 7 8 9 14 15)
					(= local19 90)
				else
					(= local19 40)
				)
			...
			(6
				(if (proc999_5 local0 9 10)
					(volleyBall dispose:)
					(sunnyTwo dispose:)
				)
				(if (proc999_5 local0 13 17) (creditProp3 dispose:))
				(if (proc999_5 local0 14 15 16 18)
					(creditProp2 dispose:)
				)
				(creditProp dispose:)
				(gOldATPs eachElementDo: #dispose)
				(gOldATPs eachElementDo: #delete)
				(gOldCast eachElementDo: #dispose)
				(gOldCast eachElementDo: #delete)
				(global2 drawPic: 780)
				(= cycles 2)
			)
			(7 (= cycles 2))
