...
(instance speedRoom of Rm
	...
	(method (init &tmp [temp0 100]) ; NSR Patch adds temp0, why? it's not used
		(proc958_0 128 104)
		(super init:)
		(gGame handsOff:)
;;;		(self setScript: speedTest) ;; NRS deletes all this
;;;	)
;;;	
...
;;;				)
;;;		)
		(= global87 15) ;; added by NRS
		(gGame detailLevel: 3) ;; added by NRS
		(= gEatTheMice 2)
