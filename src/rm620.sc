	...
	(method (init)
		...
		(switch global129
			...
			(6
				...
				(if (and (== global123 4) (gEgo has: 11))
					(animal3 setCel: 15)
				else
					(animal3 setCel: 12)
				)
		...
		(switch (= state newState)
			...
			(9
				(if
					...
					(global2 setScript: sFoundDagger)
				else
					(switch global129
						(1 (gLb2Messager say: 2 0 2))
						(2 (gLb2Messager say: 3 0 2))
						(3 (gLb2Messager say: 4 0 2))
						(4 (gLb2Messager say: 5 0 2))
						(5 (gLb2Messager say: 6 0 2))
						(6 (gLb2Messager say: 7 0 2))
						(7 (gLb2Messager say: 8 0 2))
						(8 (gLb2Messager say: 9 0 2))
						(9 (gLb2Messager say: 10 0 2))
						(10 (gLb2Messager say: 11 0 2))
						(11 (gLb2Messager say: 12 0 2))
						(12 (gLb2Messager say: 13 0 2))
						(13
							(if (proc0_2 155)
								(gLb2Messager say: 15 0 7)
							else
								(gLb2Messager say: 15 0 8)
							)
						)
						(14 (gLb2Messager say: 14 0 2))
					)
...
(instance sFoundDagger of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gLb2Messager say: 1 0 1 4 self)
			)
			(4
				(gLb2Messager say: 1 0 1 5 self)
			)
			(5
				(gLb2Messager say: 1 0 1 6 self)
			)
			(6
				(gLb2Messager say: 1 0 1 7 self)
			)
			(7
				(sFX number: 615 loop: 1 flags: 1 play: self)
				(global2 style: 9 drawPic: 785)
				(global2 setInset: inDagger)
				(= cycles 10)
			)
			(8 (gLb2Messager say: 1 0 1 8))
			(9
