...
(instance safeDoor of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 (global2 setInset: inDial))
			(8 (global2 setInset: inDial))
			(4
				(gEgo setHeading: 270)
				(++ local3)
				(cond 
					...
					((< local3 3) (global2 setInset: inDial))
...
(instance safe of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1
				(if local1
					(global2 setInset: inDiary)
				else
					(gLb2Messager say: 39 1 0 0 0 561)
				)
			)
			(8
				(if local1
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1
				...
				(gLb2Messager say: 60 1 0 0 0 561)
			)
			(else  (super doVerb: theVerb))
		)
	)
...
(instance sHeimlichEnters of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(gLb2Messager say: 3 0 87 0 self 1889)
			)
			(8
