...
(class Sound of Obj
	...
	(method (mute param1 param2 &tmp temp0 temp1)
		(if (not argc) (= temp1 1) else (= temp1 param1))
		(if (< argc 2)
			(= temp0 1)
			(while (< temp0 17)
				(DoSound sndSEND_MIDI self temp0 176 78 temp1)
				(++ temp0)
			)
		else
			(DoSound sndSEND_MIDI self param2 176 78 temp1)
		)
	)
