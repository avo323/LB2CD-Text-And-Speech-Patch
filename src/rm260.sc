...
(instance rm260 of LBRoom
	...
	(method (init)
		...
		(super init:)
		(gWrapSound number: 260 flags: 1 loop: 1 play:)
		(global2
			addObstacle:
				((Polygon new:)
					type: 2
	...
	(method (doit)
		...
		(cond 
			(script)
			((proc0_1 gEgo 16) (global2 setScript: sDownStairs))
		)
	)
...
(instance sDownStairs of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gLb2Messager say: 11 0 11 0 self)
			)
			(3
				(gGame handsOn:)
				(self dispose:)
...
(instance sTradeBaseBall of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gLb2Messager say: 18 7 0 0 self)
			...
			(7
				...
				(gEgo put: 4 get: 22 setCycle: Beg self)
			)
			(8
		...
		(switch (= state newState)
			...
			(2
				...
				(taxi
					init:
					setLoop: 5
					setMotion: MoveTo (+ (gEgo x?) 28) (+ (gEgo y?) 11) self
				)
			)
			(3
		...
		(switch theVerb
			(6
				(switch (= temp0 (global2 setInset: (ScriptID 20 0)))
					(1026
						(gLb2Messager say: 18 6 5)
					)
					(1027
						(gLb2Messager say: 18 6 6)
					)
					(1028
						(gLb2Messager say: 18 6 10)
					)
					(519 (gLb2Messager say: 18 6 4))
					(else 
						(cond 
							((< temp0 512) (gLb2Messager say: 18 6 1))
							((< temp0 768) (gLb2Messager say: 18 6 2))
							((< temp0 1024) (gLb2Messager say: 18 6 3))
						)
					)
				)
			)
			(7
				(global2 setScript: sTradeBaseBall)
			)
			(4
				(if local0
					(gLb2Messager say: 18 4 7)
					(= local0 0)
				else
					(gLb2Messager say: 18 4 8)
				)
			)
			(2
				(if local1
					(gLb2Messager say: 18 2 7)
					(= local1 0)
				else
					(gLb2Messager say: 18 2 8)
				)
			)
			(1
				(if (proc0_2 129)
					(gLb2Messager say: 18 1 12)
				else
	...
	(method (doVerb theVerb &tmp temp0)
		(switch theVerb
			(6
				(switch (= temp0 (global2 setInset: (ScriptID 20 0)))
					(1026
						(gLb2Messager say: 17 6 5)
					)
					(1027
						(gLb2Messager say: 17 6 6)
					)
					(1028
						(gLb2Messager say: 17 6 10)
					)
					(519 (gLb2Messager say: 17 6 4))
					(else 
						(cond 
							((< temp0 512) (gLb2Messager say: 17 6 1))
							((< temp0 768) (gLb2Messager say: 17 6 2))
							((< temp0 1024) (gLb2Messager say: 17 6 3))
						)
					)
				)
			)
			(2
				(cond 
					((proc0_2 129) (gLb2Messager say: 17 2 12))
					(local2 (gLb2Messager say: 17 2 7) (= local2 0))
					(else (gLb2Messager say: 17 2 8))
				)
			)
			(1
				(if (proc0_2 129)
					(gLb2Messager say: 17 1 12)
				else
					(super doVerb: theVerb)
				)
			)
	...
	(method (doVerb theVerb &tmp temp0)
		(switch theVerb
			(6
				(switch (= temp0 (global2 setInset: (ScriptID 20 0)))
					(1026
						(gLb2Messager say: 19 6 5)
					)
					(1027
						(gLb2Messager say: 19 6 6)
					)
					(1028
						(gLb2Messager say: 19 6 10)
					)
					(519 (gLb2Messager say: 19 6 4))
					(else 
						(cond 
							((< temp0 512) (gLb2Messager say: 19 6 1))
							((< temp0 768) (gLb2Messager say: 19 6 2))
							((< temp0 1024) (gLb2Messager say: 19 6 3))
						)
					)
				)
			)
