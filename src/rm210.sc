...
(instance rm210 of LBRoom
	...
	(method (init)
		...
		(switch gGNumber
			(north
				(gEgo edgeHit: 0 setHeading: 180 normalize: 803)
			)
			(south
		...
		(if (gEgo has: 0)
			...
			(gWrapSound number: 190 loop: -1 flags: 1 play:)
		)
		(frontDoor init:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(gLb2Messager say: 3 10 0 1 self)
				(luigi posn: 221 179 setCycle: 0)
			)
			(2
				(gLb2Messager say: 3 10 0 2 self)
			)
			(3
				(luigi
					loop: 1
			...
			(4
				(gLb2Messager say: 3 10 0 3 self)
			)
			(5
				(global2 setInset: sandwichI self)
			)
			(6
...
(instance luigi of Prop
	...
	(method (doVerb theVerb &tmp temp0)
		(switch theVerb
			(10
				(global2 setScript: sGetSandwich)
			)
			(2
				(cond 
					((and (not (gEgo has: 0)) (not (proc0_2 28))) (proc0_3 28) (gLb2Messager say: 3 2 1 0))
					((not (gEgo has: 0)) (gLb2Messager say: 3 2 2 0))
					((gEgo has: 0) (gLb2Messager say: 3 2 3 0))
				)
			)
			(6
				(cond 
					(
						(and
							(<= 256 (= temp0 (global2 setInset: (ScriptID 20 0))))
							(<= temp0 409)
						)
						(gLb2Messager say: 3 6 4)
					)
					((and (<= 512 temp0) (<= temp0 665)) (gLb2Messager say: 3 6 5))
					((== temp0 772) (gLb2Messager say: 3 6 8))
					((and (<= 768 temp0) (<= temp0 921)) (gLb2Messager say: 3 6 6))
					((and (<= 1024 temp0) (<= temp0 1177)) (gLb2Messager say: 3 6 7))
				)
			)
			(else 
...
(instance sandwichI of Inset
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4
				(global2 setScript: sGetSandwichInset)
			)
			(else 
				(super doVerb: theVerb &rest)
			)
