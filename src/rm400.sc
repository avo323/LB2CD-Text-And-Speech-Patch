...
(instance rm400 of LBRoom
	...
	(method (init &tmp [temp0 30])
		...
		(cond 
			(
			(or (> global123 2) (not (& $7204 global124))) (realDagger init: approachVerbs: 4 1 8))
			((not (proc0_2 71))
				((ScriptID 93 3)
					init:
					posn: 70 185
	...
	(method (newRoom)
		(gGameMusic2 stop:)
		(gWrapSound pause: 0 fade: 127 5 5 0)
		(super newRoom: &rest)
	)
)
...
(instance sHeimlichShoos of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(gLb2Messager say: 33 8 0 0 self)
			)
			(6
...
(instance sHeimlichShoos2 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gLb2Messager say: 3 0 82 0 self 1889)
			)
			(2
				(gEgo setMotion: PolyPath -50 (gEgo y?) self)
			)
			(3 (global2 newRoom: 370))
		)
	)
)
...
(instance inPittsburgh of Inset
	...
	(method (dispose)
		...
		(if (not register) (global2 setScript: sHeimlichShoos))
		(super dispose:)
	)
...
(instance fakeDaggers of Feature
	...
	(method (doVerb theVerb)
		(if (== theVerb 8)
			(global2 setInset: inPittsburgh 0 1)
		else
