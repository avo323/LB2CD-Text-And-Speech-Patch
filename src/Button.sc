		...
		(switch theVerb
			(2
				...
				(and (== (onOff cel?) 2) (== (sendReceive cel?) 2))
					(gLb2Messager say: 54 theVerb 0 (Random 2 7) 0 562)
				)
			)
...
(instance onOff of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(8
				(if (== cel 2)
					(gLb2Messager say: noun theVerb 8 0 0 562)
				else
					(gLb2Messager say: noun theVerb 9 0 0 562)
				)
			)
			(else  (super doVerb: theVerb))
		)
...
(instance sendReceive of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(8
				(if (== cel 2)
					(gLb2Messager say: noun theVerb 6 0 0 562)
				else
					(gLb2Messager say: noun theVerb 7 0 0 562)
				)
			)
			(else  (super doVerb: theVerb))
		)
...
(class Button of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(8
				(if (== cel 2)
					(gLb2Messager say: noun theVerb 12 0 0 562)
				else
					(gLb2Messager say: noun theVerb 13 0 0 562)
				)
			)
			(else  (super doVerb: theVerb))
		)
	...
	(method (cue)
		...
		(and (== (onOff cel?) 2) (== (sendReceive cel?) 1))
			...
			(gLb2Messager say: 54 4 5 0 0 562)
		)
	)
...
(instance olympiaButton of Button
	...
	(method (cue)
		...
		(and (== (onOff cel?) 2) (== (sendReceive cel?) 1))
			(sFX number: 567 flags: 1 setLoop: 1 play:)
			(if (proc0_2 51)
				(gLb2Messager say: 54 4 2 0 0 562)
			else
				(gLb2Messager say: 54 4 1 0 0 562)
				(proc0_3 51)
			)
		)
	)
	...
	(method (cue)
		...
		(and (== (onOff cel?) 2) (== (sendReceive cel?) 1))
			...
			(if (not (proc0_2 52))
				(proc0_3 52)
				(if (not (proc0_2 5))
					(gLb2Messager say: 54 4 3 0 0 562)
				else
					(gLb2Messager say: 54 4 5 0 0 562)
				)
			else
		...
		(and (== (onOff cel?) 2) (== (sendReceive cel?) 1))
			...
			(if (not (proc0_2 53))
				...
				(if (and (not (proc0_2 2)) (not (proc0_2 4)))
					(gLb2Messager say: 54 4 4 0 0 562)
				else
					(gLb2Messager say: 54 4 5 0 0 562)
				)
			else
